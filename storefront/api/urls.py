...
from .views import CanteenDetailView, CanteenListView, CanteensUserView, SurveyListByCanteen, CreateCanteenView,  CreateUserView ,  SurveysUserView, UserPermissionsView, get_users, create_user, NoteListCreate, NoteDelete, get_categories
